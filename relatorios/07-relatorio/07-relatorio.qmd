...
1.left_join(vendas =>produtos) mantem as vendas sem correspondencia na tabela
de produtos.

2. right_join(vendas =>produtos) ou left_join(produtos=>vendas) mantem todos 
os produtos, mesmo sem vendas

3.full_join mantem todos os registros de ambas as tabelas para uma analise 
completa

4.inner_join.mantem apenas registros com correspondencia em todas as tabelas
